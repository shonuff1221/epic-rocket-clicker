...
class Game extends Component {
  ...
  StartCasino() {
    ...
    if (this.state.casino_multiplier !== 0 && checkPossiblity > 0) {
      ...
      this.CasinoWin(
        this.state.casino_multiplier,
        this.state.casino_stake,
        randomnmbr
      );
    } else {
  ...
  refuel(TankValue) {
    let FullCost =
      Math.round(
        (this.state.fuelMax - this.state.fuel) * this.state.fuel_price * 100
      ) / 100;
    let checkpwrs = "";
    ...
    if (TankValue === "MAX") {
      ...
      if (
        this.state.fuelMax > this.state.fuel &&
        this.state.click > this.state.fuel_price * TankValue &&
        checkpwrs
      ) {
        this.setState((prevState) => {
          return {
      ...
      if (y < 8) {
        ...
        this.setState((lastState) => {
          return {
            ...
            fuel_usage:
              Math.round((lastState.fuel_usage + addfusage) * 100) / 100,
    ...
    return (
      <>
        <div className="mobileInfo">
          {" "}
          <h2>This game works only on desktop browser</h2>
          <center>
            {" "}
            <img
              src="https://c.tenor.com/jM88jRsqnL8AAAAC/peppo-pepe.gif"
              width="400"
              alt="info"
            />
          </center>
        ...
        <div className="fullscreen">
          <TrollMessage
            showinfo={this.state.troll_info}
            trollbtn={this.CloseTrollmsg}
          />
          <StartAlert />
          <center>
            {" "}
              ...
              <Row>
                <Col>
                  <Fuelstation
                    Btn1={() => this.refuel(1)}
                    Btn2={() => this.refuel(10)}
                    Btn3={() => this.refuel("MAX")}
                    price={this.state.fuel_price}
                    tanklevel={tanklvl}
                  />
                </Col>
                <Col>
                  <Custom
                    price={this.state.capacityPrice}
                    btn1={() => this.BuyCapacity(50)}
                    btn2={() => this.BuyCapacity(100)}
                    btn3={() => this.BuyCapacity(500)}
                  />
                </Col>
                <Col>
                  <Casino
                    ...
                    mltp2={() => this.SetCasinoMuliplier(1.5)}
                    mltp3={() => this.SetCasinoMuliplier(2.0)}
                ...
                <Container>
                  <Row>
                    <Col>
                      {" "}
                      <Booster
                        name={this.state.item_name[0]}
                        cost={this.state.item_price[0]}
                        amount={this.state.item_amount[0]}
                        buy={() => this.BuyBooster(0)}
                        bg={images.rocket1}
                        pwr={this.state.item_power[0]}
                        click={this.state.click}
                        minFuel={this.state.item_minfuel[0]}
                        fuelUsage={this.state.item_fusage[0]}
                        fmax={this.state.fuelMax}
                      />
                    </Col>
                    <Col>
                      {" "}
                      <Booster
                        name={this.state.item_name[1]}
                        cost={this.state.item_price[1]}
                        amount={this.state.item_amount[1]}
                        buy={() => this.BuyBooster(1)}
                        bg={images.rocket2}
                        pwr={this.state.item_power[1]}
                        click={this.state.click}
                        minFuel={this.state.item_minfuel[1]}
                        fuelUsage={this.state.item_fusage[1]}
                        fmax={this.state.fuelMax}
                      />{" "}
                    </Col>
                    <Col>
                      <Booster
                        name={this.state.item_name[2]}
                        cost={this.state.item_price[2]}
                        amount={this.state.item_amount[2]}
                        buy={() => this.BuyBooster(2)}
                        bg={images.rocket3}
                        pwr={this.state.item_power[2]}
                        click={this.state.click}
                        minFuel={this.state.item_minfuel[2]}
                        fuelUsage={this.state.item_fusage[2]}
                        fmax={this.state.fuelMax}
                      />{" "}
                    </Col>
                  </Row>
                ...
                <Container>
                  <Row>
                    <Col>
                      {" "}
                      <Booster
                        name={this.state.item_name[3]}
                        cost={this.state.item_price[3]}
                        amount={this.state.item_amount[3]}
                        buy={() => this.BuyBooster(3)}
                        bg={images.rocket4}
                        pwr={this.state.item_power[3]}
                        click={this.state.click}
                        minFuel={this.state.item_minfuel[3]}
                        fuelUsage={this.state.item_fusage[3]}
                        fmax={this.state.fuelMax}
                      />
                    </Col>
                    <Col>
                      {" "}
                      <Booster
                        name={this.state.item_name[4]}
                        cost={this.state.item_price[4]}
                        amount={this.state.item_amount[4]}
                        buy={() => this.BuyBooster(4)}
                        bg={images.rocket5}
                        pwr={this.state.item_power[4]}
                        click={this.state.click}
                        minFuel={this.state.item_minfuel[4]}
                        fuelUsage={this.state.item_fusage[4]}
                        fmax={this.state.fuelMax}
                      />{" "}
                    </Col>
                    <Col>
                      <Booster
                        name={this.state.item_name[5]}
                        cost={this.state.item_price[5]}
                        amount={this.state.item_amount[5]}
                        buy={() => this.BuyBooster(5)}
                        bg={images.rocket6}
                        pwr={this.state.item_power[5]}
                        click={this.state.click}
                        minFuel={this.state.item_minfuel[5]}
                        fuelUsage={this.state.item_fusage[5]}
                        fmax={this.state.fuelMax}
                      />{" "}
                    </Col>
                  </Row>
                ...
                <Container>
                  <Row>
                    <Col>
                      {" "}
                      <Booster
                        name={this.state.item_name[6]}
                        cost={this.state.item_price[6]}
                        amount={this.state.item_amount[6]}
                        buy={() => this.BuyBooster(6)}
                        bg={images.rocket7}
                        pwr={this.state.item_power[6]}
                        click={this.state.click}
                        minFuel={this.state.item_minfuel[6]}
                        fuelUsage={this.state.item_fusage[6]}
                        fmax={this.state.fuelMax}
                      />
                    </Col>
                    <Col>
                      {" "}
                      <Booster
                        name={this.state.item_name[7]}
                        cost={this.state.item_price[7]}
                        amount={this.state.item_amount[7]}
                        buy={() => this.BuyBooster(7)}
                        bg={images.rocket8}
                        pwr={this.state.item_power[7]}
                        click={this.state.click}
                        minFuel={this.state.item_minfuel[7]}
                        fuelUsage={this.state.item_fusage[7]}
                        fmax={this.state.fuelMax}
                      />{" "}
                    </Col>
                    <Col>
                      <Booster
                        name={this.state.item_name[8]}
                        cost={this.state.item_price[8]}
                        amount={this.state.item_amount[8]}
                        buy={() => this.BuyBooster(8)}
                        bg={images.rocket9}
                        pwr={this.state.item_power[8]}
                        click={this.state.click}
                        minFuel={this.state.item_minfuel[8]}
                        fuelUsage={this.state.item_fusage[8]}
                        fmax={this.state.fuelMax}
                      />{" "}
                    </Col>
                  </Row>
            ...
            <ProgressBar
              completed={Math.round(
                (this.state.fuel / this.state.fuelMax) * 100
              )}
              FuelMax={this.state.fuelMax}
              fuelUsage={this.state.fuel_usage}
            />
          </center>
        </div>{" "}
      </>
